...
const Home = () => {
    return(
        <EstruturaPagina>
            ...
            <div className="home-apresentacao">
                <div className="limitar-container">
                    ...
                    <ul className="lista-servicos">
                        ...
                        <li>
                            <img src="assets/dente.png" alt="logo" tile="logo" />
            ...
            <h2 className="titulo-sessao">Por que usar <b>aparelho ortodôntico</b></h2>
            ...
            <div className="home-depoimentos">
                ...
                <ul className="lista-depoimentos">
                    <li>
                        ...
                        <p>Alberto Silva</p>
                        <p>... "User aparelho por anos e agora posso sorrir novamente."</p> 
                    </li>
                    <li>
